...
func _on_area_entered(area):
	...
	# Check if this is a Player collision (strict check on Player script)
	elif area.get_parent() and area.get_parent().has_method("take_damage") and area.get_parent().get_script() and area.get_parent().get_script().resource_path.ends_with("Player.gd"):
	...
	# Check if this is a Force Field collision
		...
		print("=== GOLF BALL FORCE FIELD COLLISION DETECTED ===")
