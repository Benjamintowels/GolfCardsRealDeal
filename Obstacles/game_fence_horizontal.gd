...
# use to create a basic collision object for the Ball to bounce off of or pass over etc
# use the horizontal to connect multiple columns together on the tilegrid
...
func get_collision_radius() -> float:
	# Approximate half-width of the fence footprint for proximity checks
	return 60.0
